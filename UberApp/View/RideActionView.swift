...
class RideActionView: UIView{
    ...
    override init(frame: CGRect) {
        ...
        separatorView.anchor(top: uberInfoLabel.bottomAnchor, left: leftAnchor, right: rightAnchor, paddingTop: 20, height: 0.75)
    ...
    private func configureUI(withConfig config: RideActionViewConfiguration){
        ...
        case .tripAccepted:
            ...
            if user.accountType == .driver{
                titleLabel.text = "En Rote To Passenger"
